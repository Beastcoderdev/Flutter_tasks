...
void main(){
  ...
  while(true){
    ...
    Map<int, String> task_title = {
      1:'find out if number is prime or not.',
      2:'display the middle character of a string.',
      3:'find the area of a circle.',
      4:'count all words in a String.',
      5:'Simple Calculator',
      6:'entered string is a valid password.',
      7:'Employee',
